...
public class UserInterface extends JFrame {
    static final Color background = new Color(236, 186, 186);
    static final Color buttonBackground = new Color(1, 123, 189, 255);
    static final Color buttonActive = new Color(62, 178, 47);
